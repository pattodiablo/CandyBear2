import { COOKIE_STOCK_STORAGE_KEY } from "./cookieProgress";
import { ACQUIRED_COOKIE_JAR_STORAGE_KEY } from "./unlockCatalog";
import {
...
export const GAME_STORAGE_KEYS = [
	...
	TOTAL_LIKES_STORAGE_KEY,
	BEAR_LIKES_STORAGE_KEY,
	COOKIE_STOCK_STORAGE_KEY,
	ACQUIRED_COOKIE_JAR_STORAGE_KEY,
